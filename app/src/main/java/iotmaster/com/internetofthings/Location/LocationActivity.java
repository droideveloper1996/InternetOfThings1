package iotmaster.com.internetofthings.Location;
...
import iotmaster.com.internetofthings.Adapters.PlaceListAdapter;
import iotmaster.com.internetofthings.R;
import iotmaster.com.internetofthings.UserInterface.MainActivity;
import iotmaster.com.internetofthings.data.LocationContract;
...
public class LocationActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void refreshPlacesData() {
        ...
        String projection[]=new String[]{LocationEntry.PLACE_ID};
        ...
        while (data.moveToNext()) {
            guids.add(data.getString(data.getColumnIndex(LocationEntry.PLACE_ID)));
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PLACE_PICKER_REQUEST && resultCode == RESULT_OK) {
            ...
            contentValues.put(LocationEntry.PLACE_ID, placeID);
